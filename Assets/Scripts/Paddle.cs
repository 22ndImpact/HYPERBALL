...
public class Paddle : PhysicsObject {
	...
	public void StartReaching () {
		...
		glowTransform.localScale = Vector3.zero;
	}
	...
	public void UpdateCharging () {
		...
		glowTransform.localScale = new Vector3(1f, chargePercentage, 1f);
	}
	...
	void Slice () {
		...
		slicePos.x += transform.localScale.x * (maxReachDistance < 0 ? -1f : 1f) * 0.5f;
		SliceEffect.Slice(slicePos);
	}
}
